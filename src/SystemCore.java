...
class Core {
    ...
    private HashMap<Integer, SystemCall> call_list;
    private Stack stack;
    private SystemCall call;


    public Core(Stack stack1) {
        call_list = new HashMap<Integer, SystemCall>();
        call_list.put(0, new SystemCall(0, new Object[]{1, 1, 1}));
        call_list.put(1, new SystemCall(1, new Object[]{"string", 1.5, "string"}));
        call_list.put(2, new SystemCall(2, new Object[]{"string", 1 , 1.6}));
        call_list.put(3, new SystemCall(3, new Object[]{"string", "string","string"}));
        call_list.put(4,new SystemCall(4, new Object[]{1.2, 1.5, 3.5}));
        stack = stack1;
    }
